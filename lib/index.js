...
const create_api_handler_1 = require("./create-api-handler");
const create_api_instance_1 = require("./create-api-instance");
const errors_1 = require("./errors");
exports.RebillyErrors = errors_1.default;
 ...
 * @constructor
 */
function RebillyAPI({ apiKey = null, version = baseApiVersion, sandbox = false, timeout = baseTimeoutMs } = {}) {
    /**
    ...
    const apiHandler = create_api_handler_1.default({ options });
    return create_api_instance_1.default({ apiHandler });
}
exports.default = RebillyAPI;
;
/**
...
function RebillyExperimentalAPI({ apiKey = null, sandbox = false, timeout = baseTimeoutMs } = {}) {
    ...
    const apiHandler = create_api_handler_1.default({ options });
    return create_api_instance_1.createExperimentalApiInstance({ apiHandler });
}
exports.RebillyExperimentalAPI = RebillyExperimentalAPI;
